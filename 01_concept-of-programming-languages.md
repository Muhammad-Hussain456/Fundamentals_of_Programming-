...
ایک مترجم انہیں مشین زبان (0 اور 1) میں بدل دیتا ہے۔

The computer executes the machine language.

کمپیوٹر مشین زبان چلاتا ہے۔

It is difficult to write and understand machine language; that's why we use high-level programming languages as they are easy to write and understand.

مشین زبان لکھنا اور سمجھنا مشکل ہے؛ اسی لیے ہم ہائی لیول پروگرامنگ زبانیں استعمال کرتے ہیں جو آسان اور سمجھنے میں آسان ہیں۔
...
IDE ایک سافٹ ویئر ہے جو پروگرامرز کو آسانی سے کوڈ لکھنے، غلطیاں تلاش کرنے اور پروگرام چلانے میں مدد دیتا ہے۔

While an SDK is separate, some IDEs automatically install and manage the correct SDKs for you, creating a single, integrated package.
