...
|------------------------|---------------------------|----------------------------------------------------------------------------------|
| Include I/O Header    | `#include <iostream>`     | Tells the preprocessor to include the iostream header file, which declares input/output stream objects like cin, cout, cerr, etc.|
